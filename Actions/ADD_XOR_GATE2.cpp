#include"ADD_XOR_GATE2.h"
#include"..\ApplicationManager.h"


ADD_XOR_GATE2::ADD_XOR_GATE2(ApplicationManager* pXpp) :Action(pXpp)
{
}

ADD_XOR_GATE2::~ADD_XOR_GATE2(void)
{
}

void  ADD_XOR_GATE2::ReadActionParameters()
{
...
bool  ADD_XOR_GATE2::Execute()
{
	...
	GInfo.y1 = Cy - Wdth / 2;
	GInfo.y2 = Cy + Wdth / 2;
	XOR2* pN2 = new XOR2(GInfo, default_FANOUT);
	pManager->AddComponent(pN2);
	return true;
}

void ADD_XOR_GATE2::Undo()
{
	...
	GInfo = c1->GetGInfo();
	c1 = new XOR2(GInfo, default_FANOUT);
	pManager->AddToComp2(c1);
	pManager->DeleteComponent(x - 1);
}

void ADD_XOR_GATE2::Redo()
{
