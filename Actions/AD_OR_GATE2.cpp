#include"ADD_OR_GATE2.h"
#include"..\ApplicationManager.h"

ADD_OR_GATE2::ADD_OR_GATE2(ApplicationManager* popp) :Action(popp)
{
}

ADD_OR_GATE2::~ADD_OR_GATE2(void)
{
}

void ADD_OR_GATE2::ReadActionParameters()
{
...
bool ADD_OR_GATE2::Execute()
{
	...
	GInfo.y1 = Cy - Wdth / 2;
	GInfo.y2 = Cy + Wdth / 2;
	OR2* po = new OR2(GInfo, default_FANOUT);
	pManager->AddComponent(po);
	return true;
}


void ADD_OR_GATE2::Undo()
{
	...
	GInfo = c1->GetGInfo();
	c1 = new OR2(GInfo, default_FANOUT);
	pManager->AddToComp2(c1);
	pManager->DeleteComponent(x - 1);
}

void ADD_OR_GATE2::Redo()
{
