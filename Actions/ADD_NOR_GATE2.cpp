#include"ADD_NOR_GATE2.h"
#include"..\ApplicationManager.h"

ADD_NOR_GATE2::ADD_NOR_GATE2(ApplicationManager* pNo2pp) :Action(pNo2pp)
{
}

ADD_NOR_GATE2::~ADD_NOR_GATE2(void)
{
}

void ADD_NOR_GATE2::ReadActionParameters()
{
...
bool  ADD_NOR_GATE2::Execute()
{
	...
	GInfo.y1 = Cy - Wdth / 2;
	GInfo.y2 = Cy + Wdth / 2;
	NOR2* pNo2 = new NOR2(GInfo, default_FANOUT);
	pManager->AddComponent(pNo2);
	return true;
}

void ADD_NOR_GATE2::Undo()
{
	...
	GInfo = c1->GetGInfo();
	c1 = new NOR2(GInfo, default_FANOUT);
	pManager->AddToComp2(c1);
	pManager->DeleteComponent(x - 1);
}

void ADD_NOR_GATE2::Redo()
{
