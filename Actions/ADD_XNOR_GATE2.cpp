#include"ADD_XNOR_GATE2.h"
#include"..\ApplicationManager.h"

ADD_XNOR_GATE2::ADD_XNOR_GATE2(ApplicationManager* pN2pp) :Action(pN2pp)
{
}

ADD_XNOR_GATE2::~ADD_XNOR_GATE2(void)
{
}

void  ADD_XNOR_GATE2::ReadActionParameters()
{
...
bool  ADD_XNOR_GATE2::Execute()
{
	...
	GInfo.y1 = Cy - Wdth / 2;
	GInfo.y2 = Cy + Wdth / 2;
	XNOR2* pN2 = new XNOR2(GInfo, default_FANOUT);
	pManager->AddComponent(pN2);
	return true;
}

void ADD_XNOR_GATE2::Undo()
{
	...
	GInfo = c1->GetGInfo();
	c1 = new XNOR2(GInfo, default_FANOUT);
	pManager->AddToComp2(c1);
	pManager->DeleteComponent(x - 1);
}

void ADD_XNOR_GATE2::Redo()
{
